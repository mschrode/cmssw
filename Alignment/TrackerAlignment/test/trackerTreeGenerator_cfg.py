...
process.MessageLogger.cerr.TrackerTreeGenerator = cms.untracked.PSet(
...
process.TFileService = cms.Service(
    "TFileService",
    fileName = cms.string(os.environ['CMSSW_BASE'] + '/src/Alignment/TrackerAlignment/test/TrackerTree.root')
)
